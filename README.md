...
> 引流宝从2019年开源至今已获得众多使用者，在此期间有非常多支持者，目前已有8个交流群（均400人以上）。但是也有不少的“恶心用户”，对开源作者有着不友好的做法，以及本开源作品在各源码站、闲鱼等平台出现高价销售（虽然我也不在乎），但还是反映了国内开源环境的脏乱差，对于各种影响我继续开源的做法，我还是选择了不再对新版本的开源。2.4.0版本已经开发完成，为了让大家能用上开源的最后一个版本，近期将对2.4.0做好进一步的优化再发布给大家。以后引流宝如果有打算，最有可能是往加密源码、授权安装等方向发展。
