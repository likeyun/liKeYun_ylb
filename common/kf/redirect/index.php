            ...
            if($getkfldymResult){
                ...
                if($getDomainNameCheckConfig){
                    ...
                    if($domainCheck_status == 1){
                        ...
                        $checkDomainURL = $httpOrhttps.'://'.$getThisPagePath.'/console/public/domainNameCheck.php?domain='.$kf_ldym;
                        ...
                        if($checkCode == 200){
                            ...
                            // 不正常
                            // 发送通知
                            sendNotification($domainCheck_channel,'客服码'.$kf_ldym.'域名被封了！尽快处理！',$db);
                            
                            // 是否有备用域名
                            if($domainCheck_byym){
                                
                                // 使用备用域名跳转
                                jump($domainCheck_byym,$kid);
                            }else{
