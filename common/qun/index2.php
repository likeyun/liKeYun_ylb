...
<?php
    ...
    if($qid && $qid !== ''){
        ...
        if($getQunInfoResult && $getQunInfoResult > 0){
            ...
            $qun_pv = getSqlData($getQunInfoResult,'qun_pv'); // 总访问量
                ...
                if($getQrcodeListResult && $getQrcodeListResult > 0){
                    ...
                    foreach ($QrcodeList as $k => $v){
                        ...
                        if($QrcodeList[$k]['zm_pv'] < $QrcodeList[$k]['zm_yz'] && $QrcodeList[$k]['zm_status'] == 1){
                            ...
                            // 标题
                            echo '<title>群聊详情</title>';
                            
                            // 小图标
                            echo '<div class="renzheng-icon"></div>';
                            
                            // 大标题
                            echo '<div class="big-title">加入里客云科技交流群</div>';
                            
                            // 简介
                            echo '<div class="group-desc">群内讨论引流宝使用、服务器、网站搭建、支付接口、微信小程序等相关话题！</div>';
                            
                            // 群二维码显示区域
                            echo '<div class="group-qrcode">
                            <img src="https://pic.rmb.bdstatic.com/bjh/85da8da54eb01c10f34c2091c71a18b84453.png" />
                            <p class="scan-text">长按二维码进群</p>
                            </div>';
