...
function appendOptionsToSelect(selectElement, dataList) {
    ...
    if (dataList.length > 0) {
        for (var i = 0; i < dataList.length; i++) {
            selectElement.append('<option value="' + dataList[i].domain + '">' + dataList[i].domain + '</option>');
        }
    } else {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.code == 200) {
                ...
                // 创建
                appendOptionsToSelect($("#createDwzModal select[name='dwz_rkym']"), res.rkymList);
                appendOptionsToSelect($("#createDwzModal select[name='dwz_zzym']"), res.ldymList);
                appendOptionsToSelect($("#createDwzModal select[name='dwz_dlym']"), res.dlymList);
                
                // 批量创建
                appendOptionsToSelect($("#createBatchDwzModal select[name='dwz_rkym']"), res.rkymList);
                appendOptionsToSelect($("#createBatchDwzModal select[name='dwz_zzym']"), res.ldymList);
                appendOptionsToSelect($("#createBatchDwzModal select[name='dwz_dlym']"), res.dlymList);
                
                // 编辑
                appendOptionsToSelect($("#EditDwzModal select[name='dwz_rkym']"), res.rkymList);
                appendOptionsToSelect($("#EditDwzModal select[name='dwz_zzym']"), res.ldymList);
                appendOptionsToSelect($("#EditDwzModal select[name='dwz_dlym']"), res.dlymList);
            } else {
...
function initialize_getDomainNameList(module){
    ...
    if(module == 'creat'){
        ...
        $("#createDwzModal select[name='dwz_rkym']").empty();
        $("#createDwzModal select[name='dwz_zzym']").empty();
        $("#createDwzModal select[name='dwz_dlym']").empty();
        hideResult();
        ...
        $("#createDwzModal select[name='dwz_dlws']").html($dwz_dlws_HTML);
        ...
        $("#createDwzModal select[name='dwz_type']").html($dwz_type_HTML);
        
    }
    
    if(module == 'batchcreat'){
        
        // 清空域名列表
        $("#createBatchDwzModal select[name='dwz_rkym']").empty();
        $("#createBatchDwzModal select[name='dwz_zzym']").empty();
        $("#createBatchDwzModal select[name='dwz_dlym']").empty();
        ...
        $("#createBatchDwzModal select[name='dwz_dlws']").html($dwz_dlws_HTML);
        ...
        $("#createBatchDwzModal select[name='dwz_type']").html($dwz_type_HTML);
    ...
    if(module == 'edit'){
        ...
        // 将所有值清空
        $("#EditDwzModal select[name='dwz_rkym']").empty();
        $("#EditDwzModal select[name='dwz_zzym']").empty();
        $("#EditDwzModal select[name='dwz_dlym']").empty();
        hideResult();
    }
