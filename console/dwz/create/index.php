<?php
    ...
    if(empty($dwz_title) || !isset($dwz_title)){
        ...
        $result = array(
            'code' => 203,
            'msg' => '入口域名未设置，请打开console/dwz/create/index.php 第29行 进行配置'
        );
    }else if(empty($dwz_zzym) || !isset($dwz_zzym)){
        
        $result = array(
            'code' => 203,
            'msg' => '中转域名未设置，请打开console/dwz/create/index.php 第30行 进行配置'
        );
    }else if(empty($dwz_dlym) || !isset($dwz_dlym)){
        
        $result = array(
            'code' => 203,
            'msg' => '短链域名未设置，请打开console/dwz/create/index.php 第31行 进行配置'
        );
