                ...
                if(res.code == 200){
                    ...
                    if(res.ldymList.length>0){
                        for (var i=0; i<res.ldymList.length; i++) {
                            ...
                            // 有域名
                            $('#createShareCardModal select[name="shareCard_ldym"]').append(
                        ...
                        // 无域名
                        $('#createShareCardModal select[name="shareCard_ldym"]').append('<option value="">暂无落地域名</option>');
                    }
                }else{
            ...
            success: function(res){
                ...
                if(res.code == 200){
                    ...
                    if(res.ldymList.length>0){
                        ...
                        // 无域名
                        $('#editShareCardModal select[name="shareCard_ldym"]').append('<option value="">暂无落地域名</option>');
                    }
                }else{
...
function initialize_getDomainNameList(module){
    ...
    if(module == 'create'){
        ...
        $('#createShareCardModal select[name="shareCard_ldym"]').empty();
        $('#createShareCardModal input[name="shareCard_title"]').attr('autocomplete','off');
        $('#createShareCardModal input[name="shareCard_desc"]').attr('autocomplete','off');
        $('#createShareCardModal input[name="shareCard_img"]').attr('autocomplete','off');
        $('#createShareCardModal input[name="shareCard_url"]').attr('autocomplete','off');
        hideResult();
        
    }else if(module == 'edit'){
        
        // 恢复默认值
        $('#editShareCardModal select[name="shareCard_ldym"]').empty();
        $('#editShareCardModal input[name="shareCard_title"]').attr('autocomplete','off');
        $('#editShareCardModal input[name="shareCard_desc"]').attr('autocomplete','off');
        $('#editShareCardModal input[name="shareCard_img"]').attr('autocomplete','off');
        $('#editShareCardModal input[name="shareCard_url"]').attr('autocomplete','off');
        hideResult();
    }
