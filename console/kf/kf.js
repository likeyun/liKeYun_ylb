    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.code == 200){
                ...
                // 分页组件
                getKfListFenyeComponent(res.page,res.nextpage,res.prepage,res.allpage);
...
// 分页组件
function getKfListFenyeComponent(thisPage,nextPage,prePage,allPage){
                ...
                if(res.code == 200){
                    ...
                    if(res.rkymList.length>0){
                        ...
                        for (var i=0; i<res.rkymList.length; i++) {
                            ...
                            // 入口域名
                            $('#createKfModal select[name="kf_rkym"]').append(
                        ...
                        // 没有域名
                        $('#createKfModal select[name="kf_rkym"]').append('<option value="">暂无入口域名</option>');
                    }
                    ...
                    if(res.ldymList.length>0){
                        ...
                        for (var i=0; i<res.ldymList.length; i++) {
                            ...
                            // 落地域名
                            $('#createKfModal select[name="kf_ldym"]').append(
                        ...
                        // 没有域名
                        $('#createKfModal select[name="kf_ldym"]').append('<option value="">暂无落地域名</option>');
                    }
                    ...
                    if(res.dlymList.length>0){
                        ...
                        for (var i=0; i<res.dlymList.length; i++) {
                            ...
                            // 短链域名
                            $('#createKfModal select[name="kf_dlym"]').append(
                        ...
                        // 没有域名
                        $('#createKfModal select[name="kf_dlym"]').append('<option value="">暂无短链域名</option>');
                    }
                }else{
            ...
            success: function(res){
                ...
                if(res.code == 200){
                    ...
                    if(res.rkymList.length>0){
                        ...
                        // 没有域名
                        $('#EditKfModal select[name="kf_safety"]').append('<option value="">暂无入口域名</option>');
                    }
                    ...
                    if(res.ldymList.length>0){
                        ...
                        // 没有域名
                        $('#EditKfModal select[name="kf_ldym"]').append('<option value="">暂无落地域名</option>');
                    }
                    ...
                    if(res.dlymList.length>0){
                        ...
                        // 没有域名
                        $('#EditKfModal select[name="kf_dlym"]').append('<option value="">暂无短链域名</option>');
                    }
                }else{
...
function initialize_getDomainNameList(module){
    ...
    if(module == 'creat'){
        ...
        $('#createKfModal select[name="kf_rkym"]').empty();
        $('#createKfModal select[name="kf_ldym"]').empty();
        $('#createKfModal select[name="kf_dlym"]').empty();
        $('#createKfModal select[name="kf_model"]').html(
        ...
        // 恢复默认值
        $('#EditKfModal select[name="kf_rkym"]').empty();
        $('#EditKfModal select[name="kf_ldym"]').empty();
        $('#EditKfModal select[name="kf_dlym"]').empty();
        hideResult();
    }
