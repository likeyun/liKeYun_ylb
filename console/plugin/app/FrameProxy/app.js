            ...
            if(res.code == 200){
                ...
                for (var i=0; i<res.getDataList.length; i++) {
                    ...
                    var dataInfoObject = {
                        ...
                        data_mode: res.getDataList[i].data_mode,
                    ...
                    if(res.getDataList[i].data_mode == 1) {
...
function getDataInfo(dataInfoObject){
    ...
    $("#editDataModal textarea[name='data_jumplink']").val(dataInfoObject.data_jumplink);
    $("#editDataModal input[name='data_id']").val(dataInfoObject.data_id);
    $("#editDataModal select[name='data_mode']").val(dataInfoObject.data_mode);
...
function initialize_getDomainNameList(module){
    ...
    if(module == 'create'){
        ...
        $('#createDataModal textarea[name="data_jumplink"]').val('');
