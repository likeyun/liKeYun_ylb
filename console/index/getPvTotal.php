<?php
    ...
    if(isset($_SESSION["yinliubao"])){
        ...
        // 对当天各时段访问量进行求和
        $countQunPvTotal = 'SELECT SUM(count_qun_pv),SUM(count_kf_pv),SUM(count_channel_pv) FROM huoma_count';
        ...
        if($countQunPvTotalResult){
            ...
            if($count_date == date('Y-m-d')){
                ...
                $result = array(
        			'code' => 200,
        			'pvTotal' => array('qun_pvTotal' => 0,'kf_pvTotal' => 0,'channel_pvTotal' => 0),
