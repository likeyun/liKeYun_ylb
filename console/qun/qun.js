...
function getDomainNameList(module){
    ...
    // 请求地址
    var getDomainNameListReqUrl = "../public/getDomainNameList.php";
    ...
    if(module == 'create'){
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                if(res.code == 200){
                    ...
                    if(res.rkymList.length>0){
                        ...
                        // 没有域名
                        $("select[name='qun_rkym']").append('<option value="">暂无入口域名</option>');
                    }
                    ...
                    if(res.ldymList.length>0){
                        ...
                        // 没有域名
                        $("select[name='qun_ldym']").append('<option value="">暂无落地域名</option>');
                    }
                    ...
                    if(res.dlymList.length>0){
                        ...
                        // 没有域名
                        $("select[name='qun_dlym']").append('<option value="">暂无短链域名</option>');
                    }
                }else{
            ...
            error: function() {
                ...
                // 服务器发生错误
                showErrorResultForphpfileName('/public/getDomainNameList.php');
            }
        });
    }else if(module == 'edit'){
